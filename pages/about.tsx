    ...
    <div className={styles.container}>
      ...
      <div className={styles.rightside}>
        <div className={styles.first}>
          ...
          <p>
            ببینیم وب سایت ساخته شده توسط جمعی از دانشجویان دانشگاه علم وصنعت
            مباشد که در جهت ایجاد محیطی امن و پر نشاط در حوزه فیلم
            ...
            ببینیم تمام تلاش خود را به کار میگیرد تا بهترین فیلم های
